...
public class SecurityHelperForRestAssured {
    ...
    public static RequestSpecification givenAuthenticatedUser(int serverPort, String username, String password) {
        OAuth2RestTemplate template = new OAuth2RestTemplate(createResourceOwnerPasswordResourceDetails(
    ...
    private static ResourceOwnerPasswordResourceDetails createResourceOwnerPasswordResourceDetails(
